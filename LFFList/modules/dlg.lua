...
--[[17]]{F.DI_TEXT     ,  5,  10,   5, 20, 0,0,0,0, ""},
--[[18]]{F.DI_CHECKBOX ,  5,  11,   0,  0, dlg.data.appendinfile,0,0,0, M(13)},
--[[19]]{F.DI_TEXT     ,  5,  12,   0, 12, 0, 0, 0, 0, M(14)},
--[[20]]{F.DI_COMBOBOX ,  5 + M(14):len()+1, 12, 9 + M(14):len() + 7 + 1 , 0, cbxValues1, 0, 0, F.DIF_DROPDOWNLIST, dlg.data.charset},
--[[21]]--{F.DI_CHECKBOX ,  5,  13,   0, 13, dlg.data.inclipboard,0,0,0, M(15)},
--[[21]]{F.DI_TEXT ,  5,  13,   0, 13, 0,0,0,0, ""},
...
--[[33]]{F.DI_TEXT     ,w-25, 15,   0, 12, 0, 0, 0, 0, ""},
--[[34]]{F.DI_TEXT     ,w-18, 15, w-6,  0, 0, 0, 0, 0, ""},
