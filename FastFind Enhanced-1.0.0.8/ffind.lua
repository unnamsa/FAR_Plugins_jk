...
local function dlg_proc (hDlg, msg, param1, param2)
    ...
    if (msg == _F.DN_CTLCOLORDLGITEM) then
        if (param1==3 or param1==4) then
          --local index = far.Colors.COL_DIALOGLISTSELECTEDHIGHLIGHT
            local index = far.Colors.COL_DIALOGBOXTITLE
            param2[1].ForegroundColor = far.AdvControl("ACTL_GETARRAYCOLOR")[index].ForegroundColor
            return param2
        end
